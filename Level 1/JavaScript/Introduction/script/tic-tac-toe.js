...
function vari() {
    sqr1 = document.getElementsById('sqr1').value;
    sqr2 = document.getElementsById('sqr2').value;
    sqr3 = document.getElementsById('sqr3').value;
    sqr4 = document.getElementsById('sqr4').value;
    sqr5 = document.getElementsById('sqr5').value;
    sqr6 = document.getElementsById('sqr6').value;
    sqr7 = document.getElementsById('sqr7').value;
    sqr8 = document.getElementsById('sqr8').value;
    sqr9 = document.getElementsById('sqr9').value;
}
...
function winCheck() {
    ...
    else if(sqr5 == " O " && sqr7 == " O " && sqr3T == 0 && turn == 1) {
        document.tic.sqr3.value = " O ";
        sqr3T = 1;
        turn = 0;
    }
...
function blockPlayer() {
    ...
    else if(sqr5 == " X " && sqr7 == " X " && sqr3T == 0 && turn == 1) {
        document.tic.sqr3.value = " O ";
        sqr3T = 1;
        turn = 0;
    }
